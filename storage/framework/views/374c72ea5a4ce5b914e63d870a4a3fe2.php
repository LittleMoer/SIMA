<?php $__env->startSection('manajemen_akun'); ?>
...
<section>
    <div style="padding: 30px 60px">
        <div class="no_print d-flex justify-content mb-4">
            <a href="<?php echo e(route('tambah_akun')); ?>" class="btn btn-primary">
            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm edit-btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBackdrop" aria-controls="offcanvasBackdrop" data-id="<?php echo e($user->id_akun); ?>" data-name="<?php echo e($user->name); ?>" data-username="<?php echo e($user->username); ?>" data-email="<?php echo e($user->email); ?>" data-role="<?php echo e($user->role_id); ?>">Edit</button>
                            
                            <form action="<?php echo e(route('users.destroy', $user->id_akun)); ?>" method="POST" style="display:inline-block;">
                                <?php echo csrf_field(); ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        editButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                form.action = `<?php echo e(url('/manajemen_akun')); ?>/${id}`;
            });
        });
    });
</script>
<?php /**PATH C:\Users\Windows 10 Pro\Documents\work\New folder\SIMA\resources\views/manajemen_akun.blade.php ENDPATH**/ ?>