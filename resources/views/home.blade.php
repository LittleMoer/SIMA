            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                  <div style="width: 100%; overflow: hidden;">
                    <img style="width: 100%; height: 100%; object-fit: cover;" src="{{ asset('img/header.jpg') }}" alt="Image">
                  </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-8 text-start">
                                    ...
                                    {{-- <h1 class="display-1 text-white mb-5 animated slideInRight">Properti Sekitar Jawa
                                        Tengah?</h1> --}}
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('img/header.jpg') }}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 position-relative wow fadeIn" data-wow-delay="0.7s">
                            <div
                                class="about-experience bg-secondary rounded d-flex justify-content-center align-items-center text-center h-100">
                                <h3 class="mb-0">Kepuasan adalah prioritas kami</h3>
                            </div>
                        </div>
                        <div class="col-6 wow fadeIn">
                            <img class="img-fluid rounded" src="{{ asset('img/header20.png') }}">
                        </div>
                        <div class="col-6 wow fadeIn">
                            <img class="img-fluid rounded" src="{{ asset('img/headerr.jpg') }}">
                        </div>
                        <div class="col-6 wow fadeIn">
                            <img class="img-fluid rounded" src="{{ asset('img/header20.png') }}">
                        </div>
                ...
                <div class="col-lg-6 d-flex align-items-center">
                    <div>
                        ...
                        <h1 class="mb-4">Mengapa memilih <br> Ar Rayyan Property</h1>
                        <div class="row g-5 pt-2">
                            <div class="col-sm-6">
                                <h5 class="mb-3">AGENCY</h5>
                                <ul>
                                    <li>Semua data Properti yang kami tawarkan adalah selalu unit ter-update & kepastian
                                        keamanan untuk legalitasnya.</li>
                                    <li>Harga yang kami tawarkan adalah harga terbaik agar unit cepat terjual dan sesuai
                                        vendor/pemilik properti. Tidak ada mark up harga.</li>
                                    <li>Proses transaksi kami bantu hingga selesai & tuntas.</li>
                                    <li>Kami tidak memungut biaya untuk calon pembeli.</li>
                                </ul>
                            </div>
                            <div class="col-sm-6">
                                <h5 class="mb-3">KONTRAKTOR</h5>
                                <ul>
                                    <li>Kualitas terjamin & bergaransi.</li>
                                    <li>Akan mendapatkan harga terbaik.</li>
                                    <li>Free gambar & konsultasi konsep & budget.</li>
                                    <li>Dikelola oleh tim ahli terbaik & profesional di bidangnya.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col">
                            <select class="form-select" id="status">
                                <option selected value="">Disewakan/Dijual</option>
                ...
                <div class="col-md-3 mb-4 mt-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('properties.show', $property->id) }}" class="btn btn-warning btn-sm">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            @endforeach
