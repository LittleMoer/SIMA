...
<script src="https://cdn.datatables.net/1.13.7/js/jquery.dataTables.min.js"></script>
  ...
  <!-- Vendors JS -->
  <script src="{{ asset('sneat/assets/vendor/libs/nouislider/nouislider') }}"></script>
<script src="{{ asset('sneat/assets/vendor/libs/swiper/swiper') }}"></script>

  <!-- Main JS -->
  <script src="{{ asset('sneat/assets/vendor/js/front-main.js') }}"></script>
  ...
  <!-- Page JS -->
  <script src="{{ asset('sneat/assets/vendor/js/front-page-landing.js') }}"></script>
  <!-- Helpers -->
