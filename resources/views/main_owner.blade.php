    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4 ">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{ url('/manajemen_akun') }}">Manajemen Crew</a>
          </li>
        </ul
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          <!-- navbar button: Start -->
          <li>
            <a href="{{ url('/homepage') }}" class="btn btn-primary"  <i class='bx bx-log-in-circle  me-md-1'></i> <span class="d-none d-md-block"> Logout</span></a>
          </li>
          <!-- navbar button: End -->
        </ul>
        <!-- Toolbar: End -->
