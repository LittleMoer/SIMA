                ...
                <div class="tab-content">
                   {{-- Tab Surat Pemesanan --}}
                    ...
                    <div class="tab-pane fade" id="SuratJalan" role="tabpanel">
                        <div class="container">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h2>Surat Jalan {{ $datasj->id_sj }}</h2>
                                 ...
                                 <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select class="form-select @error('id_armada') is-invalid @enderror" id="id_armada" name="id_armada" >
                                                <option value="">{{ $datasj->id_armada }} </option>
                                                <option value="101" {{ $datasj->id_armada == 101 ? 'selected' : '' }}>101</option>
                                                <option value="102" {{ $datasj->id_armada== 102 ? 'selected' : '' }}>102</option>
                                                <option value="103" {{ $datasj->id_armada== 103 ? 'selected' : '' }}>103</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
