                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="SuratPesanan" role="tabpanel">
                        <div class="container">
                            ...
                            <form action="{{ route('detail_pesanan', $sp->id_sp) }}"
                                method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="jumlah_armada" id="jumlah_armada"
                                            ...
                                            value="{{ $sp->jumlah_armada }}" aria-label="Jumlah Armada" min="1"
                                            max="2" required attern="^[0-9]+$"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min="1" name="nilai_kontrak1" id="nilai_kontrak1"
                                            class="form-control" placeholder="Masukkan nilai kontrak"
                                            value="{{ $sp->nilai_kontrak1 }}" aria-label="Nilai Kontrak" required />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="nilai_kontrak2" id="nilai_kontrak2"
                                            class="form-control" placeholder="Masukkan nilai kontrak"
                                            value="{{ $sp->nilai_kontrak2 }}" aria-label="Nilai Kontrak" min="0"
                    ...
                    <div class="tab-pane fade" id="SuratJalan" role="tabpanel">
                        <div class="container">
                            @foreach($sjs as $index => $sj)
                                ...
                                <form method="POST"
                                    action="{{ route('pesanan.updateSJ', $sj->id_sj) }}#SuratJalan">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row">
                                        <label for="driver_{{ $sj->id_sj }}"
                                            class="col-sm-2 col-form-label form-label">Driver:</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="codriver_{{ $sj->id_sj }}"
                                            class="col-sm-2 col-form-label form-label">Co-Driver:</label>
                                        <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <input type="text" name="kmsebelum" id="kmsebelum_{{ $sj->id_sj }}"
                                                    ...
                                                    title="Harus berupa angka" pattern="^\d+(\.\d{1,2})?$" step="0.01">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <input type="number" name="kasbonbbm" id="kasbonbbm_{{ $sj->id_sj }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <input type="number" name="lainlain" id="lainlain_{{ $sj->id_sj }}"
                            ...
                            @foreach($spjs as $index => $spj)
                                ...
                                <div class="form-group">
                                    <a href="{{ route('bbm.index', $spj->id_spj) }}"
                                        class="btn btn-primary mb-4">Konsumsi
                                        BBM</a>
