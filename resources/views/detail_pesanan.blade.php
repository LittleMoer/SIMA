                            ...
                            <form action="{{ route('detail_pesanan', $sp->id_sp) }}" method="POST" data-type="SP" data-id="{{ $sp->id_sp }}" class="form-update">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <!-- marketing -->
                                        <div class="row mb-3">
                                            <label for="marketing" class="col-sm-4 col-form-label form-label">Marketing</label>
                                            <div class="col-sm-8">
                                                <div class="input-group input-group-merge">
                                                    <select class="form-select" name="marketing" required>
                                                        ...
                                                        @if ($akun->role_id == 1)
                                                        <option value="{{ $akun->id_akun }}">{{ $akun->name }}</option>
                                                        @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                            ...
                            <form method="POST" action="{{ route('pesanan.updateSJ', $sj->id_sj) }}#SuratJalan" data-type="SJ" data-id="{{ $sj->id_sj }}" class="form-update">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- Lain-lain -->
                                        <div class="row mb-3">
                                            <label for="lainlain_{{ $sj->id_sj }}" class="col-sm-3 col-form-label form-label">Uang Saku</label>
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-merge">
                                                    <input type="text" class="form-control currency-input"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group md-4">
                                            @if ($index == 0 && isset($sp))
                                            <h5 id="nilai_kontrak1_{{ $index }}" class="row-sm-4 row-form-label">Nilai Kontrak 1 : Rp {{ number_format($sp->nilai_kontrak1, 0, ',', '.') }} </h5>
                                            @elseif (isset($sp))
                                            <h5 id="nilai_kontrak2_{{ $index }}" class="row-sm-4 row-form-label">Nilai Kontrak 2 : Rp {{ number_format($sp->nilai_kontrak2, 0, ',', '.') }} </h5>
                                            @endif
                                            <h5 id="kasbon_bbm_{{ $index }}" class="row-sm-4 row-form-label">Kasbon BBM : Rp {{ number_format($sjs[$index]->kasbonbbm, 0, ',', '.') }} </h5> 
                                            <h5 id="kasbon_makan_{{ $index }}" class="row-sm-4 row-form-label">Kasbon Makan : Rp {{ number_format($sjs[$index]->kasbonmakan, 0, ',', '.') }} </h5> 
                                            <h5 id="uang_saku_{{ $index }}" class="row-sm-4 row-form-label">Uang Saku : Rp {{ number_format($sjs[$index]->lainlain, 0, ',', '.') }} </h5> 
                                        </div>
                                        <!-- Saldo E-toll Awal -->
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="kmsebelum_{{ $sjs[$index] }}"
                                                    class="form-control currency-input"
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="kmtiba_{{ $sjs[$index] }}"
                                                    class="form-control"
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="kmtempuh_{{ $sjs[$index] }}"
                                                    class="form-control"
