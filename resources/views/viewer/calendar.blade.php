            ...
            <div class="card">
                <div class="container" style="padding: 30px 30px">
                    <div class="d-flex align-items-center mb-4">
                        <a
                            href="{{ route('viewer.calendar', ['month' => $month == 1 ? 12 : $month - 1, 'year' => $month == 1 ? $year - 1 : $year]) }}">
                        ...
                        <a
                            href="{{ route('viewer.calendar', ['month' => $month == 12 ? 1 : $month + 1, 'year' => $month == 12 ? $year + 1 : $year]) }}">
